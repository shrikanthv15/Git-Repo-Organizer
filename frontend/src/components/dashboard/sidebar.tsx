    ...
    return (
        <aside className="relative z-10 flex w-16 flex-col items-center border-r border-white/10 bg-card/50 backdrop-blur-sm py-4">
            ...
            <button
                ...
                className="mt-auto flex h-10 w-10 items-center justify-center rounded-lg text-muted-foreground transition-all duration-300 hover:bg-red-500/10 hover:text-red-400"
                aria-label="Sign Out"
                title="Sign Out"
            >
